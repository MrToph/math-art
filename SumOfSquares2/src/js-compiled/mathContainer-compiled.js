...
var _templateObject = _taggedTemplateLiteral(["definecolor{colorRed}{RGB}{255,50,50}definecolor{colorGreen}{RGB}{50,205,50}\n                                    definecolor{colorBlue}{RGB}{50,50,255}definecolor{colorYellow}{RGB}{255,165,0}definecolor{colorPurple}{RGB}{138,43,226}"], ["\\definecolor{colorRed}{RGB}{255,50,50}\\definecolor{colorGreen}{RGB}{50,205,50}\n                                    \\definecolor{colorBlue}{RGB}{50,50,255}\\definecolor{colorYellow}{RGB}{255,165,0}\\definecolor{colorPurple}{RGB}{138,43,226}"]),
    _templateObject2 = _taggedTemplateLiteral(["\textcolor{colorRed}{1^2} + \textcolor{colorGreen}{2^2} + \textcolor{colorBlue}{3^2} + ldots + \textcolor{colorYellow}{n^2}"], ["\\textcolor{colorRed}{1^2} + \\textcolor{colorGreen}{2^2} + \\textcolor{colorBlue}{3^2} + \\ldots + \\textcolor{colorYellow}{n^2}"]),
    _templateObject3 = _taggedTemplateLiteral(["3 (\textcolor{colorRed}{1^2} + \textcolor{colorGreen}{2^2} + \textcolor{colorBlue}{3^2} + ldots + \textcolor{colorYellow}{n^2}) \n                                    = \frac{n (n+1)}{2} \textcolor{colorPurple}{(2n + 1)}"], ["3 (\\textcolor{colorRed}{1^2} + \\textcolor{colorGreen}{2^2} + \\textcolor{colorBlue}{3^2} + \\ldots + \\textcolor{colorYellow}{n^2}) \n                                    = \\frac{n (n+1)}{2} \\textcolor{colorPurple}{(2n + 1)}"]);
